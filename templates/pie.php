<div class = "container">
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Bebos en tu celular</h5>
                        <center>
                            <p class="card-text">Descarga nuestra App</p>
                            <img src="imagenes/googleplay.png" width="90px">
                            <img src="imagenes/app-store.svg" width="90px">
                            <br>
                            <p class="card-text">Tambien disponible para Huawei</p>
                            <img src="imagenes/appgallery.png" width="90px">
                        </center>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="fondo text-secondary px-4 py-5 text-center">
        <div class="py-5">
        <h1 class="display-5 fw-bold text-white">Tienda Bebos</h1>
            <div class="col-lg-6 mx-auto">
                <p class="text-white">Jimenez Morales Angelina</p>
                <p class="text-white">Moreno Vega Luis Angel</p>
                <p class="text-white">Rojas Huerta Inés Yaelin</p>
