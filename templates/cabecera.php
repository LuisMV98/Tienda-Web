    ...
    <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-auto me-auto">
            <button type="button" class="btn boton" onclick="location.href='login.php'">Iniciar sesion</button>
          </div>
        </div>
</header>
    ...
    <div class="principal">
      <nav class="navbar navbar-expand-lg navbar-dark"  style="background-color: #913730;">
        <div class="container-fluid">
            ...
            <span class="borde">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-house-door" viewBox="0 0 15 15">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <center>
                  <span class="borde">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 640 512">
              ...
              <li class="nav-item">
                <center>
                  <span class="borde">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 384 512">
